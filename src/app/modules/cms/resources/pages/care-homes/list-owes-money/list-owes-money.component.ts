...
@Component({
    selector: 'app-list-owes-money',
    templateUrl: './list-owes-money.component.html',
    styleUrls: ['./list-owes-money.component.scss']
})
export class ListOwesMoneyComponent implements OnInit {
